...
1. **AI is not optional.** Every student graduates with:
   ...
   - Prompt engineering and RAG (Retrieval-Augmented Generation) skills
   - Practical understanding of model evaluation and responsible AI
   - Portfolio of AI-assisted analytics projects
...
3. **Aligned with Gies' Campus AI Framework.** MSBAi contributes to the official Campus AI curriculum tracks:
   ...
   - **Agentic Systems & Workflows:** Design AI-enhanced business processes
...
4. **Cross-course convergence**
   - Week 3-4: All courses converge on **visualization & storytelling** (SQL, Python, Tableau)
   - Week 5-6: All courses converge on **regression analysis** (finance, business problems)
   - Week 7-8: **Synthesis & presentations** (all courses capstone simultaneously)
